...
const Bio = () => {
  return (
    <div id='bio' className='flex bg-background-soft gap-10 p-10'>
        <div className='flex flex-col gap-10 flex-3 pl-5'>
            <div className='flex gap-4 items-center'>
                <div className='relative p-2 hover:scale-102 group transition-all duration-300'>
                    ...
                    <Image 
                        className='grayscale group-hover:grayscale-0 transition-[filter] duration-300 border border-foreground-muted rounded-sm w-40 h-40'
                        src={'/alex_photo.jpg'}
                        alt={'Profile Picture'}
                        width={160}
                        height={160}
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    <p className='text-foreground font-semibold font-sans text-3xl'>Building robust<br/>digital solutions.</p>
                </div>
            </div>
        ...
        <div className='flex flex-col gap-4 flex-2'>
            <div className='group flex flex-col gap-4 flex-1 relative p-4 justify-center pl-6 rounded-lg border border-[rgba(255,255,255,0.1)] bg-[#35353550] hover:border-[#FF4F0080] transition-all duration-300'>
            ...
            <div className='group flex flex-col gap-4 flex-1 relative p-4 pl-6 justify-center rounded-lg border border-[rgba(255,255,255,0.1)] bg-[#35353550] hover:border-[#FF4F0080] transition-all duration-300'>
                <div className='flex flex-col gap-1'>
